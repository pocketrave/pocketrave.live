...
import InspiredBySphere from "@/components/InspiredBySphere";

export default function LiveActsPage() {
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
      <div className="max-w-7xl mx-auto px-4 py-6 md:px-16 md:py-16">
        <div className="font-orbitron space-y-6 md:space-y-10">
          <h1 className="text-5xl font-bold mb-4 md:mb-8" style={{ fontVariationSettings: '"wght" 700' }}>
            Live Acts
          </h1>
          <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_360px] xl:gap-12">
            <section className="max-w-4xl space-y-4 md:space-y-6">
            ...
            <div className="xl:pt-1 xl:sticky xl:top-24 xl:h-fit">
              <InspiredBySphere />
            </div>
          </div>
        </div>
